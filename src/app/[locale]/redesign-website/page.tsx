...
export async function generateMetadata({
  ...
  const localizedUrl = `${baseUrl}/${locale}/redesign-website/`;
  ...
  return {
    ...
    alternates: {
      ...
      languages: {
        ro: `${baseUrl}/ro/redesign-website/`,
        en: `${baseUrl}/en/redesign-website/`,
      },
    },
    openGraph: {
      title: dictionary.services?.redesign_website?.page_title,
...
export default async function RedesignWebsitePage({
  ...
  return (
    <>
      ...
      />
      <ServicePageClient serviceKey="redesign_website" locale={locale} />
    </>
  );
}
